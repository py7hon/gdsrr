...
?>
    ...
    <main class="white-text">
      <div class="container">
        ...
        <p>This is the home of a new project, that uses Google Drive for decentralized file sharing. Any files you copy or upload, you MUST have the right to distribute, since they may be listed publicly, and as such - they WILL be removed if the author / creator of the file contacts us. Other than that - please do not submit anything that violates any laws - our servers are located in the Indonesian, and will be subject to local laws. Due to the decentralized nature of this site; we cannot guarantee the full removal of any file. We are able to remove it from public listing, but any mirrored copies are simply out of our control. Please be aware of this before anything is shared - we cannot be held responsible for any consequences of your actions.</p>
      </div>
    </main>
